/*
  ...
  - The values [PENDING,SHIPPED,REFUNDED] on the enum `OrderItemStatus` will be removed. If these variants are still used in the database, this will fail.
...
-- AlterEnum
BEGIN;
CREATE TYPE "OrderItemStatus_new" AS ENUM ('PROCESSING', 'DELIVERED', 'CANCELLED');
...
-- AlterEnum
BEGIN;
CREATE TYPE "OrderStatus_new" AS ENUM ('PROCESSING', 'DELIVERED', 'CANCELLED');
